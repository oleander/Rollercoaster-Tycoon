...
public class Main extends java.lang.Object {
    ...
    public Op_ext.JRProxyOp JRget_op_runner_intTovoid()
    {
        return op_runner_intTovoid;
    }
    
    public Op_ext.JRProxyOp op_runner_intTovoid;
    class ProcOp_intTovoid_implrunner extends ProcOp_ext_impl
    {
        Main thisarg;
        public ProcOp_intTovoid_implrunner(Main thisIn) throws RemoteException
        {
        thisarg = thisIn;
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                thisarg.runnerintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    thisarg.runnerintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    public void runnerintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_runner_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private void runnerintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int n = ((Number) JRargs[0]).intValue();
            {
                // Begin Expr2
                JR.nap(this.r.nextInt(15000));
                // Begin Expr2
                new Customer(this.rc.queue, "Name-" + n);
                // Return
                { if (retOp != null)
    ...
    protected void JRinit() {
    	...
    	try {
    	op_runner_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implrunner(this));
    	} catch (Exception JRe)
    	{ throw new jrRuntimeError(JRe.toString()); }
    	jrresref = new JRMain(op_runner_intTovoid);
    	this.JRcalled = true;
    }
    ...
    private void JRprocess() {
    	...
    	try {
    	  for (int n = 0; n < 20; n++) 
    	  {
    		op_runner_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {n});
    	  }
